...
The game can be run by double clicking on the newton_adventure-1.1-SNAPSHOT.jar
file or using one of the run_* script. It will run in 800x600 resolution
by default, but this can be configured in the data/config.properties file.
...
java -jar -Dorg.lwjgl.util.Debug=true newton_adventure-1.1-SNAPSHOT.jar
